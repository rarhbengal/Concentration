...
map.getView().fit([9446807.500325, 2473758.121888, 9942547.293789, 2832064.033195], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">TOURIST SPOTS & HOTESL CONCENTRATION INDEX</h2>';
        return titleElement;
    })(),
